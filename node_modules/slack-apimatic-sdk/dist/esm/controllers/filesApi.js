 ...
 */
import { filesDeleteSchemaSchema, } from '../models/filesDeleteSchema.js';
import { filesInfoSchemaSchema, } from '../models/filesInfoSchema.js';
import { filesListSchemaSchema, } from '../models/filesListSchema.js';
import { filesRevokePublicUrlSchemaSchema, } from '../models/filesRevokePublicUrlSchema.js';
import { filesSharedPublicUrlSchemaSchema, } from '../models/filesSharedPublicUrlSchema.js';
import { filesUploadSchemaSchema, } from '../models/filesUploadSchema.js';
...
export class FilesApi extends BaseApi {
     ...
     */
    async filesDelete(token, file, requestOptions) {
     ...
     * @return Response from the API call
     */
    async filesInfo(token, file, count, page, limit, cursor, requestOptions) {
     ...
     * @return Response from the API call
     */
    async filesList(token, user, channel, tsFrom, tsTo, types, count, page, showFilesHiddenByLimit, requestOptions) {
     ...
     * @return Response from the API call
     */
    async filesRevokePublicUrl(token, file, requestOptions) {
        ...
        req.header('token', mapped.token);
        req.form({ file: mapped.file });
        req.defaultToError(FilesRevokePublicUrlErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async filesSharedPublicUrl(token, file, requestOptions) {
        ...
        req.header('token', mapped.token);
        req.form({ file: mapped.file });
        req.defaultToError(FilesSharedPublicUrlErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async filesUpload(token, file, content, filetype, filename, title, initialComment, channels, threadTs, requestOptions) {
