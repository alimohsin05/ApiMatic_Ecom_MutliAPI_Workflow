...
export class WorkflowsApi extends BaseApi {
     ...
     */
    async workflowsStepCompleted(token, workflowStepExecuteId, outputs, requestOptions) {
     ...
     * @return Response from the API call
     */
    async workflowsStepFailed(token, workflowStepExecuteId, error, requestOptions) {
     ...
     * @return Response from the API call
     */
    async workflowsUpdateStep(token, workflowStepEditId, inputs, outputs, stepName, stepImageUrl, requestOptions) {
...
//# sourceMappingURL=workflowsApi.js.map