 ...
 */
import { adminConversationsArchiveSchemaSchema, } from '../models/adminConversationsArchiveSchema.js';
import { adminConversationsConvertToPrivateSchemaSchema, } from '../models/adminConversationsConvertToPrivateSchema.js';
import { adminConversationsCreateSchemaSchema, } from '../models/adminConversationsCreateSchema.js';
import { adminConversationsDeleteSchemaSchema, } from '../models/adminConversationsDeleteSchema.js';
import { adminConversationsGetConversationPrefsSchemaSchema, } from '../models/adminConversationsGetConversationPrefsSchema.js';
import { adminConversationsGetTeamsSchemaSchema, } from '../models/adminConversationsGetTeamsSchema.js';
import { adminConversationsInviteSchemaSchema, } from '../models/adminConversationsInviteSchema.js';
import { adminConversationsRenameSchemaSchema, } from '../models/adminConversationsRenameSchema.js';
import { adminConversationsRenameSchema1Schema, } from '../models/adminConversationsRenameSchema1.js';
import { adminConversationsSearchSchemaSchema, } from '../models/adminConversationsSearchSchema.js';
import { adminConversationsSetConversationPrefsSchemaSchema, } from '../models/adminConversationsSetConversationPrefsSchema.js';
import { adminConversationsUnarchiveSchemaSchema, } from '../models/adminConversationsUnarchiveSchema.js';
import { defaultSuccessTemplateSchema, } from '../models/defaultSuccessTemplate.js';
...
export class AdminConversationsApi extends BaseApi {
     ...
     */
    async adminConversationsArchive(token, channelId, requestOptions) {
        ...
        req.defaultToError(AdminConversationsArchiveErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(adminConversationsArchiveSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async adminConversationsConvertToPrivate(token, channelId, requestOptions) {
        const req = this.createRequest('POST', '/admin.conversations.convertToPrivate');
        const mapped = req.prepareArgs({
            token: [token, string()],
            channelId: [channelId, string()],
        });
        ...
        req.header('Content-Type', 'application/x-www-form-urlencoded');
        req.form({ channel_id: mapped.channelId });
        req.defaultToError(AdminConversationsConvertToPrivateErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(adminConversationsConvertToPrivateSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async adminConversationsCreate(token, name, isPrivate, description, orgWide, teamId, requestOptions) {
        ...
        req.defaultToError(AdminConversationsCreateErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async adminConversationsDelete(token, channelId, requestOptions) {
        ...
        req.header('Content-Type', 'application/x-www-form-urlencoded');
        req.form({ channel_id: mapped.channelId });
        req.defaultToError(AdminConversationsDeleteErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async adminConversationsDisconnectShared(token, channelId, leavingTeamIds, requestOptions) {
        const req = this.createRequest('POST', '/admin.conversations.disconnectShared');
        const mapped = req.prepareArgs({
            token: [token, string()],
            channelId: [channelId, string()],
        ...
        req.defaultToError(AdminConversationsDisconnectSharedErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async adminConversationsGetConversationPrefs(token, channelId, requestOptions) {
        const req = this.createRequest('GET', '/admin.conversations.getConversationPrefs');
        const mapped = req.prepareArgs({
            token: [token, string()],
            channelId: [channelId, string()],
        });
        ...
        req.defaultToError(AdminConversationsUnarchiveErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(adminConversationsGetConversationPrefsSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async adminConversationsGetTeams(token, channelId, cursor, limit, requestOptions) {
        ...
        req.defaultToError(AdminConversationsGetTeamsErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(adminConversationsGetTeamsSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async adminConversationsInvite(token, userIds, channelId, requestOptions) {
        ...
        req.defaultToError(AdminConversationsInviteErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async adminConversationsRename(token, channelId, name, requestOptions) {
        ...
        req.defaultToError(AdminConversationsUnarchiveErrorSchema2Error, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(adminConversationsRenameSchema1Schema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async adminConversationsSearch(token, teamIds, query, limit, cursor, searchChannelTypes, sort, sortDir, requestOptions) {
        ...
        req.defaultToError(AdminConversationsSearchErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async adminConversationsSetConversationPrefs(token, channelId, prefs, requestOptions) {
        const req = this.createRequest('POST', '/admin.conversations.setConversationPrefs');
        const mapped = req.prepareArgs({
            token: [token, string()],
            channelId: [channelId, string()],
            prefs: [prefs, string()],
        ...
        req.defaultToError(AdminConversationsSetConversationPrefsErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(adminConversationsSetConversationPrefsSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async adminConversationsSetTeams(token, channelId, teamId, targetTeamIds, orgChannel, requestOptions) {
     ...
     * @return Response from the API call
     */
    async adminConversationsUnarchive(token, channelId, requestOptions) {
        ...
        req.header('Content-Type', 'application/x-www-form-urlencoded');
        req.form({ channel_id: mapped.channelId });
        req.defaultToError(AdminConversationsUnarchiveErrorSchema3Error, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(adminConversationsUnarchiveSchemaSchema, requestOptions);
    }
}
//# sourceMappingURL=adminConversationsApi.js.map