 ...
 */
import { remindersAddSchemaSchema, } from '../models/remindersAddSchema.js';
import { remindersCompleteSchemaSchema, } from '../models/remindersCompleteSchema.js';
import { remindersDeleteSchemaSchema, } from '../models/remindersDeleteSchema.js';
import { remindersInfoSchemaSchema, } from '../models/remindersInfoSchema.js';
import { remindersListSchemaSchema, } from '../models/remindersListSchema.js';
...
export class RemindersApi extends BaseApi {
     ...
     */
    async remindersAdd(token, text, time, user, requestOptions) {
     ...
     * @return Response from the API call
     */
    async remindersComplete(token, reminder, requestOptions) {
        ...
        req.defaultToError(RemindersCompleteErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async remindersDelete(token, reminder, requestOptions) {
        ...
        req.header('token', mapped.token);
        req.form({ reminder: mapped.reminder });
        req.defaultToError(RemindersDeleteErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async remindersInfo(token, reminder, requestOptions) {
     ...
     * @return Response from the API call
     */
    async remindersList(token, requestOptions) {
