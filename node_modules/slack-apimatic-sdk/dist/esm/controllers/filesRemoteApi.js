...
export class FilesRemoteApi extends BaseApi {
     ...
     */
    async filesRemoteAdd(token, externalId, title, filetype, externalUrl, previewImage, indexableFileContents, requestOptions) {
     ...
     * @return Response from the API call
     */
    async filesRemoteInfo(token, file, externalId, requestOptions) {
     ...
     * @return Response from the API call
     */
    async filesRemoteList(token, channel, tsFrom, tsTo, limit, cursor, requestOptions) {
     ...
     * @return Response from the API call
     */
    async filesRemoteRemove(token, file, externalId, requestOptions) {
     ...
     * @return Response from the API call
     */
    async filesRemoteShare(token, file, externalId, channels, requestOptions) {
     ...
     * @return Response from the API call
     */
    async filesRemoteUpdate(token, file, externalId, title, filetype, externalUrl, previewImage, indexableFileContents, requestOptions) {
...
//# sourceMappingURL=filesRemoteApi.js.map