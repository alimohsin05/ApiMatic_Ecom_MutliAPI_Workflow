...
export class AdminConversationsRestrictAccessApi extends BaseApi {
     ...
     */
    async adminConversationsRestrictAccessAddGroup(token, groupId, channelId, teamId, requestOptions) {
        const req = this.createRequest('POST', '/admin.conversations.restrictAccess.addGroup');
     ...
     * @return Response from the API call
     */
    async adminConversationsRestrictAccessListGroups(token, channelId, teamId, requestOptions) {
        const req = this.createRequest('GET', '/admin.conversations.restrictAccess.listGroups');
        const mapped = req.prepareArgs({
            token: [token, string()],
            channelId: [channelId, string()],
            teamId: [teamId, optional(string())],
     ...
     * @return Response from the API call
     */
    async adminConversationsRestrictAccessRemoveGroup(token, teamId, groupId, channelId, requestOptions) {
        const req = this.createRequest('POST', '/admin.conversations.restrictAccess.removeGroup');
        const mapped = req.prepareArgs({
            token: [token, string()],
...
//# sourceMappingURL=adminConversationsRestrictAccessApi.js.map