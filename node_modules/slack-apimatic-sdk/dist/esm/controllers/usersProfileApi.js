 ...
 */
import { usersProfileGetSchemaSchema, } from '../models/usersProfileGetSchema.js';
import { usersProfileSetSchemaSchema, } from '../models/usersProfileSetSchema.js';
...
export class UsersProfileApi extends BaseApi {
     ...
     */
    async usersProfileGet(token, includeLabels, user, requestOptions) {
        ...
        req.defaultToError(UsersProfileGetErrorSchemaError, 'Typical error response');
     ...
     * @return Response from the API call
     */
    async usersProfileSet(token, name, profile, user, value, requestOptions) {
        ...
        req.defaultToError(UsersProfileSetErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(usersProfileSetSchemaSchema, requestOptions);
    }
}
//# sourceMappingURL=usersProfileApi.js.map