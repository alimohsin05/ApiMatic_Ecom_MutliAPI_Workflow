 ...
 */
import { reactionsAddSchemaSchema, } from '../models/reactionsAddSchema.js';
import { reactionsListSchemaSchema, } from '../models/reactionsListSchema.js';
import { reactionsRemoveSchemaSchema, } from '../models/reactionsRemoveSchema.js';
...
export class ReactionsApi extends BaseApi {
     ...
     */
    async reactionsAdd(channel, name, timestamp, token, requestOptions) {
     ...
     * @return Response from the API call
     */
    async reactionsGet(token, channel, file, fileComment, full, timestamp, requestOptions) {
     ...
     * @return Response from the API call
     */
    async reactionsList(token, user, full, count, page, cursor, limit, requestOptions) {
     ...
     * @return Response from the API call
     */
    async reactionsRemove(token, name, file, fileComment, channel, timestamp, requestOptions) {
        ...
        req.defaultToError(ReactionsRemoveErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(reactionsRemoveSchemaSchema, requestOptions);
    }
}
//# sourceMappingURL=reactionsApi.js.map