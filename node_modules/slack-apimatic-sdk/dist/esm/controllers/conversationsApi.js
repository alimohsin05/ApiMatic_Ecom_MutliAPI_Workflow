 ...
 */
import { conversationsArchiveSuccessSchemaSchema, } from '../models/conversationsArchiveSuccessSchema.js';
import { conversationsCloseSuccessSchemaSchema, } from '../models/conversationsCloseSuccessSchema.js';
import { conversationsCreateSuccessSchemaSchema, } from '../models/conversationsCreateSuccessSchema.js';
import { conversationsHistorySuccessSchemaSchema, } from '../models/conversationsHistorySuccessSchema.js';
import { conversationsInfoSuccessSchemaSchema, } from '../models/conversationsInfoSuccessSchema.js';
import { conversationsInviteErrorSchemaSchema, } from '../models/conversationsInviteErrorSchema.js';
import { conversationsJoinSuccessSchemaSchema, } from '../models/conversationsJoinSuccessSchema.js';
import { conversationsKickSuccessSchemaSchema, } from '../models/conversationsKickSuccessSchema.js';
import { conversationsLeaveSuccessSchemaSchema, } from '../models/conversationsLeaveSuccessSchema.js';
import { conversationsListSuccessSchemaSchema, } from '../models/conversationsListSuccessSchema.js';
import { conversationsMarkSuccessSchemaSchema, } from '../models/conversationsMarkSuccessSchema.js';
import { conversationsMembersSuccessSchemaSchema, } from '../models/conversationsMembersSuccessSchema.js';
import { conversationsOpenSuccessSchemaSchema, } from '../models/conversationsOpenSuccessSchema.js';
import { conversationsRenameSuccessSchemaSchema, } from '../models/conversationsRenameSuccessSchema.js';
import { conversationsRepliesSuccessSchemaSchema, } from '../models/conversationsRepliesSuccessSchema.js';
import { conversationsSetPurposeSuccessSchemaSchema, } from '../models/conversationsSetPurposeSuccessSchema.js';
import { conversationsSetTopicSuccessSchemaSchema, } from '../models/conversationsSetTopicSuccessSchema.js';
import { conversationsUnarchiveSuccessSchemaSchema, } from '../models/conversationsUnarchiveSuccessSchema.js';
...
export class ConversationsApi extends BaseApi {
     ...
     */
    async conversationsArchive(token, channel, requestOptions) {
        ...
        req.defaultToError(ConversationsArchiveErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(conversationsArchiveSuccessSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async conversationsClose(token, channel, requestOptions) {
        ...
        req.header('token', mapped.token);
        req.form({ channel: mapped.channel });
        req.defaultToError(ConversationsCloseErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(conversationsCloseSuccessSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async conversationsCreate(token, name, isPrivate, requestOptions) {
        ...
        req.defaultToError(ConversationsCreateErrorSchemaError, 'Typical error response when name already in use');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(conversationsCreateSuccessSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async conversationsHistory(token, channel, latest, oldest, inclusive, limit, cursor, requestOptions) {
        ...
        req.defaultToError(ConversationsHistoryErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(conversationsHistorySuccessSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async conversationsInfo(token, channel, includeLocale, includeNumMembers, requestOptions) {
        ...
        req.defaultToError(ConversationsInfoErrorSchemaError, 'Typical error response when a channel cannot be found');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async conversationsInvite(token, channel, users, requestOptions) {
        ...
        req.defaultToError(ConversationsInviteErrorSchema1Error, 'Typical error response when an invite is attempted on a conversation type that does not support it');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async conversationsJoin(token, channel, requestOptions) {
        ...
        req.header('token', mapped.token);
        req.form({ channel: mapped.channel });
        req.defaultToError(ConversationsJoinErrorSchemaError, 'Typical error response if the conversation is archived and cannot be joined');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async conversationsKick(token, channel, user, requestOptions) {
        ...
        req.defaultToError(ConversationsKickErrorSchemaError, 'Typical error response when you attempt to kick yourself from a channel');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async conversationsLeave(token, channel, requestOptions) {
        ...
        req.header('token', mapped.token);
        req.form({ channel: mapped.channel });
        req.defaultToError(ConversationsLeaveErrorSchemaError, 'Typical error response when attempting to leave a workspace\'s "general" channel');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(conversationsLeaveSuccessSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async conversationsList(token, excludeArchived, types, limit, cursor, requestOptions) {
        ...
        req.query('limit', mapped.limit);
        req.query('cursor', mapped.cursor);
        req.defaultToError(ConversationsListErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async conversationsMark(token, channel, ts, requestOptions) {
        ...
        req.defaultToError(ConversationsMarkErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async conversationsMembers(token, channel, limit, cursor, requestOptions) {
        ...
        req.query('limit', mapped.limit);
        req.query('cursor', mapped.cursor);
        req.defaultToError(ConversationsMembersErrorSchemaError, 'Typical error response when an invalid cursor is provided');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(conversationsMembersSuccessSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async conversationsOpen(token, channel, users, returnIm, requestOptions) {
        ...
        req.defaultToError(ConversationsOpenErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async conversationsRename(token, channel, name, requestOptions) {
        ...
        req.defaultToError(ConversationsRenameErrorSchemaError, 'Typical error response when the calling user is not a member of the conversation');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(conversationsRenameSuccessSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async conversationsReplies(token, channel, ts, latest, oldest, inclusive, limit, cursor, requestOptions) {
        ...
        req.query('limit', mapped.limit);
        req.query('cursor', mapped.cursor);
        req.defaultToError(ConversationsRepliesErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(conversationsRepliesSuccessSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async conversationsSetPurpose(token, channel, purpose, requestOptions) {
        ...
        req.defaultToError(ConversationsSetPurposeErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(conversationsSetPurposeSuccessSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async conversationsSetTopic(token, channel, topic, requestOptions) {
        ...
        req.defaultToError(ConversationsSetTopicErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(conversationsSetTopicSuccessSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async conversationsUnarchive(token, channel, requestOptions) {
        ...
        req.header('token', mapped.token);
        req.form({ channel: mapped.channel });
        req.defaultToError(ConversationsUnarchiveErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(conversationsUnarchiveSuccessSchemaSchema, requestOptions);
    }
}
