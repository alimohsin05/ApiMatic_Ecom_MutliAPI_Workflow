...
export class AdminUsergroupsApi extends BaseApi {
     ...
     */
    async adminUsergroupsAddChannels(token, usergroupId, channelIds, teamId, requestOptions) {
        ...
        req.defaultToError(DefaultErrorTemplateError, 'Typical error response if the token provided is not associated with an Org Admin or Owner');
     ...
     * @return Response from the API call
     */
    async adminUsergroupsAddTeams(token, usergroupId, teamIds, autoProvision, requestOptions) {
     ...
     * @return Response from the API call
     */
    async adminUsergroupsListChannels(token, usergroupId, teamId, includeNumMembers, requestOptions) {
     ...
     * @return Response from the API call
     */
    async adminUsergroupsRemoveChannels(token, usergroupId, channelIds, requestOptions) {
...
//# sourceMappingURL=adminUsergroupsApi.js.map