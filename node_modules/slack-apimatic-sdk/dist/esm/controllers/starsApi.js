 ...
 */
import { starsAddSchemaSchema, } from '../models/starsAddSchema.js';
import { starsListSchemaSchema, } from '../models/starsListSchema.js';
import { starsRemoveSchemaSchema, } from '../models/starsRemoveSchema.js';
...
export class StarsApi extends BaseApi {
     ...
     */
    async starsAdd(token, channel, file, fileComment, timestamp, requestOptions) {
     ...
     * @return Response from the API call
     */
    async starsList(token, count, page, cursor, limit, requestOptions) {
     ...
     * @return Response from the API call
     */
    async starsRemove(token, channel, file, fileComment, timestamp, requestOptions) {
...
//# sourceMappingURL=starsApi.js.map