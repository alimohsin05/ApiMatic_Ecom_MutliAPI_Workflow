 ...
 */
import { usergroupsUsersListSchemaSchema, } from '../models/usergroupsUsersListSchema.js';
import { usergroupsUsersUpdateSchemaSchema, } from '../models/usergroupsUsersUpdateSchema.js';
...
export class UsergroupsUsersApi extends BaseApi {
     ...
     */
    async usergroupsUsersList(token, usergroup, includeDisabled, requestOptions) {
        ...
        req.defaultToError(UsergroupsUsersListErrorSchemaError, 'Standard failure response when used with an invalid token');
     ...
     * @return Response from the API call
     */
    async usergroupsUsersUpdate(token, usergroup, users, includeCount, requestOptions) {
        ...
        req.defaultToError(UsergroupsUsersUpdateErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(usergroupsUsersUpdateSchemaSchema, requestOptions);
    }
}
//# sourceMappingURL=usergroupsUsersApi.js.map