 ...
 */
import { apiMethodUsersGetPresenceSchema, } from '../models/apiMethodUsersGetPresence.js';
import { usersConversationsSuccessSchemaSchema, } from '../models/usersConversationsSuccessSchema.js';
import { usersDeletePhotoSchemaSchema, } from '../models/usersDeletePhotoSchema.js';
import { usersInfoSuccessSchemaSchema, } from '../models/usersInfoSuccessSchema.js';
import { usersListSchemaSchema, } from '../models/usersListSchema.js';
import { usersLookupByEmailSuccessSchemaSchema, } from '../models/usersLookupByEmailSuccessSchema.js';
import { usersSetActiveSchemaSchema, } from '../models/usersSetActiveSchema.js';
import { usersSetPhotoSchemaSchema, } from '../models/usersSetPhotoSchema.js';
import { usersSetPresenceSchemaSchema, } from '../models/usersSetPresenceSchema.js';
...
export class UsersApi extends BaseApi {
     ...
     */
    async usersConversations(token, user, types, excludeArchived, limit, cursor, requestOptions) {
        ...
        req.defaultToError(UsersConversationsErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(usersConversationsSuccessSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async usersDeletePhoto(token, requestOptions) {
        ...
        req.defaultToError(UsersDeletePhotoErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async usersGetPresence(token, user, requestOptions) {
     ...
     * @return Response from the API call
     */
    async usersIdentity(token, requestOptions) {
     ...
     * @return Response from the API call
     */
    async usersInfo(token, includeLocale, user, requestOptions) {
     ...
     * @return Response from the API call
     */
    async usersList(token, limit, cursor, includeLocale, requestOptions) {
     ...
     * @return Response from the API call
     */
    async usersLookupByEmail(token, email, requestOptions) {
        ...
        req.defaultToError(UsersLookupByEmailErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(usersLookupByEmailSuccessSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async usersSetActive(token, requestOptions) {
        const req = this.createRequest('POST', '/users.setActive');
        const mapped = req.prepareArgs({ token: [token, string()] });
        req.header('token', mapped.token);
        req.header('Content-Type', 'application/x-www-form-urlencoded');
        req.defaultToError(UsersSetActiveErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async usersSetPhoto(token, cropW, cropX, cropY, image, requestOptions) {
     ...
     * @return Response from the API call
     */
    async usersSetPresence(token, presence, requestOptions) {
        ...
        req.defaultToError(UsersSetPresenceErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
