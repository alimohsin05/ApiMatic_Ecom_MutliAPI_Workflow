...
export class AdminTeamsSettingsApi extends BaseApi {
     ...
     */
    async adminTeamsSettingsInfo(token, teamId, requestOptions) {
     ...
     * @return Response from the API call
     */
    async adminTeamsSettingsSetDefaultChannels(token, teamId, channelIds, requestOptions) {
        const req = this.createRequest('POST', '/admin.teams.settings.setDefaultChannels');
        const mapped = req.prepareArgs({
            token: [token, string()],
            teamId: [teamId, string()],
     ...
     * @return Response from the API call
     */
    async adminTeamsSettingsSetDescription(token, teamId, description, requestOptions) {
        const req = this.createRequest('POST', '/admin.teams.settings.setDescription');
        const mapped = req.prepareArgs({
            token: [token, string()],
            teamId: [teamId, string()],
     ...
     * @return Response from the API call
     */
    async adminTeamsSettingsSetDiscoverability(token, teamId, discoverability, requestOptions) {
        const req = this.createRequest('POST', '/admin.teams.settings.setDiscoverability');
        const mapped = req.prepareArgs({
            token: [token, string()],
            teamId: [teamId, string()],
     ...
     * @return Response from the API call
     */
    async adminTeamsSettingsSetIcon(token, imageUrl, teamId, requestOptions) {
     ...
     * @return Response from the API call
     */
    async adminTeamsSettingsSetName(token, teamId, name, requestOptions) {
...
//# sourceMappingURL=adminTeamsSettingsApi.js.map