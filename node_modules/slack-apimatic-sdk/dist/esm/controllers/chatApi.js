 ...
 */
import { chatDeleteScheduledMessageSchemaSchema, } from '../models/chatDeleteScheduledMessageSchema.js';
import { chatDeleteSuccessSchemaSchema, } from '../models/chatDeleteSuccessSchema.js';
import { chatGetPermalinkSuccessSchemaSchema, } from '../models/chatGetPermalinkSuccessSchema.js';
import { chatMeMessageSchemaSchema, } from '../models/chatMeMessageSchema.js';
import { chatPostEphemeralSuccessSchemaSchema, } from '../models/chatPostEphemeralSuccessSchema.js';
import { chatPostMessageSuccessSchemaSchema, } from '../models/chatPostMessageSuccessSchema.js';
import { chatScheduleMessageSuccessSchemaSchema, } from '../models/chatScheduleMessageSuccessSchema.js';
import { chatUnfurlSuccessSchemaSchema, } from '../models/chatUnfurlSuccessSchema.js';
import { chatUpdateSuccessSchemaSchema, } from '../models/chatUpdateSuccessSchema.js';
...
export class ChatApi extends BaseApi {
     ...
     */
    async chatDelete(token, ts, channel, asUser, requestOptions) {
     ...
     * @return Response from the API call
     */
    async chatDeleteScheduledMessage(token, channel, scheduledMessageId, asUser, requestOptions) {
        ...
        req.defaultToError(ChatDeleteScheduledMessageErrorSchemaError, 'Typical error response if no message is found');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(chatDeleteScheduledMessageSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async chatGetPermalink(token, channel, messageTs, requestOptions) {
        ...
        req.defaultToError(ChatGetPermalinkErrorSchemaError, 'Error response when channel cannot be found');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async chatMeMessage(token, channel, text, requestOptions) {
     ...
     * @return Response from the API call
     */
    async chatPostEphemeral(token, channel, user, asUser, attachments, blocks, iconEmoji, iconUrl, linkNames, parse, text, threadTs, username, requestOptions) {
        ...
        req.defaultToError(ChatPostEphemeralErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async chatPostMessage(token, channel, asUser, attachments, blocks, iconEmoji, iconUrl, linkNames, mrkdwn, parse, replyBroadcast, text, threadTs, unfurlLinks, unfurlMedia, username, requestOptions) {
        ...
        req.defaultToError(ChatPostMessageErrorSchemaError, 'Typical error response if too many attachments are included');
        req.authenticate([{ slackAuth: true }]);
     ...
     * @return Response from the API call
     */
    async chatScheduleMessage(token, channel, text, postAt, parse, asUser, linkNames, attachments, blocks, unfurlLinks, unfurlMedia, threadTs, replyBroadcast, requestOptions) {
        ...
        req.defaultToError(ChatScheduleMessageErrorSchemaError, 'Typical error response if the `post_at` is invalid (ex. in the past or too far into the future)');
        req.authenticate([{ slackAuth: true }]);
        return req.callAsJson(chatScheduleMessageSuccessSchemaSchema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async chatUnfurl(token, channel, ts, unfurls, userAuthMessage, userAuthRequired, userAuthUrl, requestOptions) {
     ...
     * @return Response from the API call
     */
    async chatUpdate(token, channel, ts, asUser, attachments, blocks, linkNames, parse, text, requestOptions) {
