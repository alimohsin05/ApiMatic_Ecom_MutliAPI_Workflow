...
export class ViewsApi extends BaseApi {
     ...
     */
    async viewsOpen(token, triggerId, view, requestOptions) {
        ...
        req.defaultToError(DefaultErrorTemplateError, 'Typical error response, before getting to any possible validation errors.');
     ...
     * @return Response from the API call
     */
    async viewsPublish(token, userId, view, hash, requestOptions) {
     ...
     * @return Response from the API call
     */
    async viewsPush(token, triggerId, view, requestOptions) {
     ...
     * @return Response from the API call
     */
    async viewsUpdate(token, viewId, externalId, view, hash, requestOptions) {
