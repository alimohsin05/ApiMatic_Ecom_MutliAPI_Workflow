...
export class AdminInviteRequestsApprovedApi extends BaseApi {
     ...
     */
    async adminInviteRequestsApprovedList(token, teamId, cursor, limit, requestOptions) {
        const req = this.createRequest('GET', '/admin.inviteRequests.approved.list');
...
//# sourceMappingURL=adminInviteRequestsApprovedApi.js.map