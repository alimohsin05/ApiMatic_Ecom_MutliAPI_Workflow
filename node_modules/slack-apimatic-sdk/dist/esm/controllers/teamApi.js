...
import { teamAccessLogsSchemaSchema, } from '../models/teamAccessLogsSchema.js';
import { teamInfoSchemaSchema, } from '../models/teamInfoSchema.js';
import { teamIntegrationLogsSchemaSchema, } from '../models/teamIntegrationLogsSchema.js';
...
export class TeamApi extends BaseApi {
     ...
     */
    async teamAccessLogs(token, before, count, page, requestOptions) {
        ...
        req.defaultToError(TeamAccessLogsErrorSchemaError, 'A workspace must be on a paid plan to use this method, otherwise the `paid_only` error is thrown:');
     ...
     * @return Response from the API call
     */
    async teamBillableInfo(token, user, requestOptions) {
     ...
     * @return Response from the API call
     */
    async teamInfo(token, team, requestOptions) {
     ...
     * @return Response from the API call
     */
    async teamIntegrationLogs(token, appId, changeType, count, page, serviceId, user, requestOptions) {
        ...
        req.query('user', mapped.user);
        req.defaultToError(TeamIntegrationLogsErrorSchemaError, 'Typical error response');
        req.authenticate([{ slackAuth: true }]);
