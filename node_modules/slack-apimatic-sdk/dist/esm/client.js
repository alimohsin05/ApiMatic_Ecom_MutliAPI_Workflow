...
export class Client {
    constructor(config) {
        ...
        const clonedConfig = Object.assign(Object.assign({}, this._config), { authorizationCodeAuthCredentials: this._config
                .authorizationCodeAuthCredentials || {
                oauthClientId: '',
                oauthClientSecret: '',
                oauthRedirectUri: '',
            } });
        this._userAgent = updateUserAgent('TypeScript-SDK/1.0.0 (OS: {os-info}, Engine: {engine}/{engine-version})');
        this._requestBuilderFactory = createRequestHandlerFactory((server) => getBaseUri(server, this._config), createAuthProviderFromConfig(this._config, () => this.authorizationCodeAuthManager), new HttpClient(AbortError, {
        ...
        this.authorizationCodeAuthManager = new AuthorizationCodeAuthManager(clonedConfig.authorizationCodeAuthCredentials, getBaseUri('auth server', this._config), this);
    }
