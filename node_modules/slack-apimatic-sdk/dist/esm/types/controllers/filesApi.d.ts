...
import { FilesDeleteSchema } from '../models/filesDeleteSchema.js';
import { FilesInfoSchema } from '../models/filesInfoSchema.js';
import { FilesListSchema } from '../models/filesListSchema.js';
import { FilesRevokePublicUrlSchema } from '../models/filesRevokePublicUrlSchema.js';
import { FilesSharedPublicUrlSchema } from '../models/filesSharedPublicUrlSchema.js';
import { FilesUploadSchema } from '../models/filesUploadSchema.js';
...
export declare class FilesApi extends BaseApi {
     ...
     */
    filesDelete(token?: string, file?: string, requestOptions?: RequestOptions): Promise<ApiResponse<FilesDeleteSchema>>;
    /**
     ...
     * @return Response from the API call
     */
    filesInfo(token?: string, file?: string, count?: string, page?: string, limit?: number, cursor?: string, requestOptions?: RequestOptions): Promise<ApiResponse<FilesInfoSchema>>;
    /**
     ...
     * @return Response from the API call
     */
    filesList(token?: string, user?: string, channel?: string, tsFrom?: number, tsTo?: number, types?: string, count?: string, page?: string, showFilesHiddenByLimit?: boolean, requestOptions?: RequestOptions): Promise<ApiResponse<FilesListSchema>>;
    /**
     ...
     * @return Response from the API call
     */
    filesRevokePublicUrl(token?: string, file?: string, requestOptions?: RequestOptions): Promise<ApiResponse<FilesRevokePublicUrlSchema>>;
    /**
     ...
     * @return Response from the API call
     */
    filesSharedPublicUrl(token?: string, file?: string, requestOptions?: RequestOptions): Promise<ApiResponse<FilesSharedPublicUrlSchema>>;
    /**
     ...
     * @return Response from the API call
     */
    filesUpload(token?: string, file?: string, content?: string, filetype?: string, filename?: string, title?: string, initialComment?: string, channels?: string, threadTs?: number, requestOptions?: RequestOptions): Promise<ApiResponse<FilesUploadSchema>>;
}
