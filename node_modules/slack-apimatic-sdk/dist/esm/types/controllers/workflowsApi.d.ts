...
import { DefaultSuccessTemplate } from '../models/defaultSuccessTemplate.js';
...
export declare class WorkflowsApi extends BaseApi {
     ...
     */
    workflowsStepCompleted(token: string, workflowStepExecuteId: string, outputs?: string, requestOptions?: RequestOptions): Promise<ApiResponse<DefaultSuccessTemplate>>;
    /**
     ...
     * @return Response from the API call
     */
    workflowsStepFailed(token: string, workflowStepExecuteId: string, error: string, requestOptions?: RequestOptions): Promise<ApiResponse<DefaultSuccessTemplate>>;
    /**
     ...
     * @return Response from the API call
     */
    workflowsUpdateStep(token: string, workflowStepEditId: string, inputs?: string, outputs?: string, stepName?: string, stepImageUrl?: string, requestOptions?: RequestOptions): Promise<ApiResponse<DefaultSuccessTemplate>>;
}
