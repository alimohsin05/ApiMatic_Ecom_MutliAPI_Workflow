...
var Client = /** @class */ (function () {
    function Client(config) {
        ...
        this._userAgent = (0, core_js_4.updateUserAgent)('TypeScript-SDK/1.0.1 (OS: {os-info}, Engine: {engine}/{engine-version})');
        this._requestBuilderFactory = createRequestHandlerFactory(function (server) { return getBaseUri(server, _this._config); }, (0, authProvider_js_1.createAuthProviderFromConfig)(this._config), new clientAdapter_js_1.HttpClient(core_js_5.AbortError, {
...
function getBaseUri(server, config) {
    ...
    if (config.environment === configuration_js_1.Environment.Production) {
        if (server === 'default') {
            return 'https://accounts.twilio.com';
        }
        if (server === 'default1') {
            return 'https://chat.twilio.com';
        }
        if (server === 'default2') {
            return 'https://conversations.twilio.com';
        }
        if (server === 'default3') {
            return 'https://notify.twilio.com';
        }
        if (server === 'default4') {
...
function withAuthenticationByDefault(rb) {
    rb.authenticate([{ accountSidAuthToken: true }]);
}
