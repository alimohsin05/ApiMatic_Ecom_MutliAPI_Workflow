...
export const workerSchema: Schema<Worker> = typedExpandoObject(
  {
    accountSid: ['account_sid', optional(nullable(string()))],
    activityName: ['activity_name', optional(nullable(string()))],
    activitySid: ['activity_sid', optional(nullable(string()))],
    attributes: ['attributes', optional(nullable(string()))],
    available: ['available', optional(nullable(boolean()))],
    dateCreated: ['date_created', optional(nullable(string()))],
    dateStatusChanged: ['date_status_changed', optional(nullable(string()))],
