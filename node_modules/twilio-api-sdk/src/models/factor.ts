...
import {
  ...
  factorEnumFactorStatusesSchema,
} from './factorEnumFactorStatuses.js';
import {
  FactorEnumFactorType,
  factorEnumFactorTypeSchema,
} from './factorEnumFactorType.js';
...
export interface Factor {
  ...
  factorType?: FactorEnumFactorType;
...
export const factorSchema: Schema<Factor> = typedExpandoObject(
  {
    ...
    status: ['status', optional(factorEnumFactorStatusesSchema)],
    factorType: ['factor_type', optional(factorEnumFactorTypeSchema)],
