...
export interface MsgGeopermissions {
...
export const msgGeopermissionsSchema: Schema<MsgGeopermissions> = typedExpandoObject(
  { permissions: ['permissions', optional(nullable(unknown()))] },
