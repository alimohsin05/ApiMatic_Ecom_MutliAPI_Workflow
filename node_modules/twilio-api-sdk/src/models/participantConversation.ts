...
import {
  ...
  participantConversationStateSchema,
} from './participantConversationState.js';
...
export interface ParticipantConversation {
  ...
  participantMessagingBinding?: unknown | null;
  ...
  conversationTimers?: unknown | null;
...
export const participantConversationSchema: Schema<ParticipantConversation> = typedExpandoObject(
  {
