...
export const conversationMessageSchema: Schema<ConversationMessage> = typedExpandoObject(
  {
    ...
    author: ['author', optional(nullable(string()))],
    body: ['body', optional(nullable(string()))],
    media: ['media', optional(nullable(array(unknown())))],
    ...
    delivery: ['delivery', optional(nullable(unknown()))],
    links: ['links', optional(nullable(unknown()))],
    contentSid: ['content_sid', optional(nullable(string()))],
  },
