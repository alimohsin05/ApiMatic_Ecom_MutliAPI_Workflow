...
export interface TaskQueueBulkRealTimeStatistics {
...
export const taskQueueBulkRealTimeStatisticsSchema: Schema<TaskQueueBulkRealTimeStatistics> = typedExpandoObject(
  {
    accountSid: ['account_sid', optional(nullable(string()))],
    workspaceSid: ['workspace_sid', optional(nullable(string()))],
    taskQueueData: ['task_queue_data', optional(nullable(array(unknown())))],
    taskQueueResponseCount: ['task_queue_response_count', optional(number())],
