...
import {
  ...
  serviceConversationMessageReceiptDeliveryStatusSchema,
} from './serviceConversationMessageReceiptDeliveryStatus.js';

export interface ServiceConversationMessageReceipt {
...
export const serviceConversationMessageReceiptSchema: Schema<ServiceConversationMessageReceipt> = typedExpandoObject(
  {
    ...
    messageSid: ['message_sid', optional(nullable(string()))],
    sid: ['sid', optional(nullable(string()))],
    channelMessageSid: ['channel_message_sid', optional(nullable(string()))],
    participantSid: ['participant_sid', optional(nullable(string()))],
    status: [
      'status',
      optional(serviceConversationMessageReceiptDeliveryStatusSchema),
    ],
    errorCode: ['error_code', optional(number())],
